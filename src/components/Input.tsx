  ...
  return (
    <>
      <label className="relative flex">
        <input
          className="flex items-center text-center pr-8 invalid:border-ux-error  focus:outline-primary-default-Solid focus:outline-2 border border-primary-default-Solid
					  rounded-lg py-5  w-full h-auto"
          type={props.type}
